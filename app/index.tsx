...
export default function App() {
  ...
  //4° requisito
  const [userEmail,setUserEmail] = useState('daiarabarroso09@gmail.com')
  const [userName,setUserName] = useState('Daiara Maria Barroso Camêlo')
  const [userBirthday,setUserBirthday] = useState('11/10')
  const [userPassword, setUserPassword] = useState('12345')
  

  const handleLogin = () => {
    if (email === "daiarabarroso09@gmail.com" && password === 12345) {
  ...
  return (
    <SafeAreaView >
        <View style={styles.container}>
          ...
          <Text style={styles.creator}>Criado por Daiara Barroso</Text>
        </View>
    </SafeAreaView>
  )
}
